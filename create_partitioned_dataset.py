...
def main():
    ...
    # Create output fname
    f_out_general = os.path.join(os.getcwd(),"data","PROCESSED_general_dataset_norm_tensor.pkl")
    ...
    # Create output fname
    f_out_target = os.path.join(os.getcwd(),"data","PROCESSED_target_dataset_norm_tensor.pkl")
